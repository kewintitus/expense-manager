...
const IncomeAccountsPie = ({ startDate, endDate, sessionEmail }) => {
  ...
  const getSpendAccountData = async () => {
    const data = await axios.get(
      `${process.env.NEXT_PUBLIC_APIURL}/api/transactions/analysis/accounts/${sessionEmail}?fromDate=${startDate}&toDate=${endDate}&txnType=income`
    );
...
export default IncomeAccountsPie;
